  ...
  return (
    <>
      ...
      style={{
        textAlign: 'center',
        padding: '20px',
        backgroundImage: 'url("../userbgimg.avif")',
    ...
    >
        <h1 className="UserHomepagetitle">
          Welcome to Online Vaccine Management
        </h1>
        <p className="Userhomepageparagraph">
          ...
          <div style={{ width: '45%', padding: '20px', background: 'rgba(255, 255, 255, 0.8)', borderRadius: '10px', opacity: '0.8' }}>
